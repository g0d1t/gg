...
main_admin_id = 6812092996

# لیست لینکدونی ها را اینجا قرار بده
linkdoni_list = ["@linkdoni","@linkdoniXe","@linkdoniVe","@idsendr","@mehdiLinkdonii","@linkdoni24h","@liinkdooniiraniian","@LinkdoniCactus","@Li_mc","@linkdooni_iraniann", ]
